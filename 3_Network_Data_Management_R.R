...
network.vertex.names(net2) <- c(LETTERS[1:5])
summary(net2)
...
network.vertex.names(netval1) <- c(LETTERS[1:5])
...
network.vertex.names(net1symm) <- c(LETTERS[1:5])
summary(net1symm)
